...
public class DialogoVenderCarro extends JDialog
{
    ...
    public DialogoVenderCarro()
    {
        ...
        String texto = vista.PanelEntradaDatos.getEmpleado();
        lbNombreVendedor = new JLabel("Vendedor: " + texto);
        lbNombreVendedor.setFont(new Font("ARIAL",Font.BOLD,15));
        lbNombreVendedor.setBounds(15,15,140,20);
